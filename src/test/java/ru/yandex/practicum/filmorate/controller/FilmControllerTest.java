...
//    @Autowired
//    public FilmControllerTest(FilmService filmService, UserService userService) {
//        super(filmService, userService);
//    }
//
//    @Test
//    public void addFilmWithEmptyName() {
//        FilmController filmController = new FilmControllerTest(this.filmService, this.userService);
